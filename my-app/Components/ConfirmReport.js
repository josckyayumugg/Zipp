...
export default function ConfirmReportProduct({
  ...
  const { mutate, isPending: isPendingReport } = useReportProduct();
      ...
      <View style={styles.overlay}>
        ...
        >
          ...
          <Text style={[{ fontSize: 16 }, styles.centerText]}>
            Seller has no product
          </Text>
          <Text
            style={[
              { fontSize: 16, color: GlobalStyles.Kn_orange },
              styles.centerText,
            ]}
          >
            (usanze umucuruzi adafite igicuruzwa?)
          </Text>
          <Text style={[styles.bold, styles.paragraph]}>"{item}"</Text>
          <Text style={{ fontSize: 16 }}>This action cannot be undone</Text>
          <View style={[styles.row, styles.actionContainer]}>
            ...
            <Button
                  ...
                  { id: id, reported: true },
                  {
                    onSuccess: () => {
                      Toast.show({
                        type: "success",
                        text1: "Success 👋",
                        text2: "Product Reported successfully!",
              ...
              content={isPendingReport ? "Reporting..." : "Report"}
            />
          </View>
        </View>
      </View>
